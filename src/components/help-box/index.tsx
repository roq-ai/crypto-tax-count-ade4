...
export const HelpBox: React.FC = () => {
  ...
  const tenantRoles: string[] = ['Business Owner', 'Financial Manager', 'Accountant', 'Tax Consultant'];
  const addOns: string[] = ['file', 'chat'];
  const applicationName = `Crypto Tax Counter`;
